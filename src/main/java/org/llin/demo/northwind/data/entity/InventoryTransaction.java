...
public class InventoryTransaction implements _Entity {
    ...
    public InventoryTransactionType getInventoryTransactionType() { return inventoryTransactionType; }
    ...
    public void setCustomerOrder(CustomerOrder customerOrder) {  // ← FIXED setter name
    ...
    public LocalDateTime getTransactionCreatedDate() { return transactionCreatedDate; }
    ...
    public LocalDateTime getTransactionModifiedDate() { return transactionModifiedDate; }
    ...
    public String toString() {
        return "InventoryTransaction [id=" + id + ", product=" + product +
               ...
               ", customerOrder=" + customerOrder + ", purchaseOrder=" + purchaseOrder + "]";
    }
}